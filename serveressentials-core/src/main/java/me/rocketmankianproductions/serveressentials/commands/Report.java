            ...
            if (ServerEssentials.permissionChecker(player, "se.reportuser")) {
                if (args.length >= 2) {
                    ...
                    if (target == sender) {
                        ...
                        if (ServerEssentials.isConnectedToDiscordSRV && ServerEssentials.getPlugin().getConfig().getBoolean("enable-staff-discord-integration") == true) {
