    ...
    public static void setup() {
        ...
        if (!file.exists()) {
            try {
                ...
                fileConfig.addDefault("eco-balance", "&aBalance: &e<balance>");
                ...
                fileConfig.addDefault("jail-target-attempt", "&6You are still &cjailed. &6Time left: &e<duration>. &6Reason: &e<reason>.");
                ...
                fileConfig.addDefault("nickname-reset", "&6Your Nickname has been reset");
                fileConfig.addDefault("nickname-set-target", "&e<player>'s &6Nickname has been set to &e<nickname>");
                fileConfig.addDefault("nickname-reset-target", "&e<player>'s &6Nickname has been reset");
            ...
            try {
                ...
                if (fileConfig.getString("eco-receive") == null) {
                    fileConfig.set("eco-receive", "&aYou have received &e<amount> &afrom &b<player>. &aYou now have: &e<balance>");
                }

                if (fileConfig.getString("eco-insufficient") == null) {
                    fileConfig.set("eco-insufficient", "&cYou do not have enough money to send.");
                }

                if (fileConfig.getString("eco-invalid") == null) {
                    fileConfig.set("eco-invalid", "&cAmount is &60 or less.");
                }

                if (fileConfig.getString("eco-balance") == null) {
                    fileConfig.set("eco-balance", "&aBalance: &e<balance>");
                }

                if (fileConfig.getString("eco-balance-target") == null) {
                    fileConfig.set("eco-balance-target", "&b<player>'s &aBalance: &e<balance>");
                }
                ...
                if (fileConfig.getString("eco-baltop") == null) {
                    fileConfig.set("eco-baltop", "&6---- Top Balances ----");
                }

                if (fileConfig.getString("eco-baltop-empty") == null) {
                    fileConfig.set("eco-baltop-empty", "&6No player balances can be found.");
                }

                if (fileConfig.getString("eco-baltop-player") == null) {
                    fileConfig.set("eco-baltop-player", "&e<number>. <player>: &a<balance>");
                }

                if (fileConfig.getString("eco-give") == null) {
                ...
                if (fileConfig.getString("eco-reset-target") == null) {
                    fileConfig.set("eco-reset-target", "&aYour balance has been reset by &b<player> to &e<balance>");
                }
                ...
                if (fileConfig.getString("jail-success") == null) {
                    fileConfig.set("jail-success", "&6Sent &e<player> &6to &e<jail> Jail &6for &e<duration> &6for the reason &e<reason>.");
                }
                ...
                if (fileConfig.getString("jail-target-attempt") == null) {
                    fileConfig.set("jail-target-attempt", "&6You are still &cjailed. &6Time left: &e<duration>. &6Reason: &e<reason>.");
                }
                ...
                if (fileConfig.getString("nickname-reset") == null) {
                    fileConfig.set("nickname-reset", "&6Your Nickname has been reset");
                }
                ...
                if (fileConfig.getString("nickname-reset-target") == null) {
                    fileConfig.set("nickname-reset-target", "&e<player>'s &6Nickname has been reset");
                }
                fileConfig.options().copyDefaults(true);
                fileConfig.save(file);
            } catch (IOException e) {
